...
function form_selectable_cell($contents, $id, $width='', $style_or_class = '', $title = '') {
	...
	if ($title != '') {
		$wrapper = "<span class='cactiTooltipHint' style='padding:10px;margin:10px;' title='" . str_replace(array('"', "'"), '', $title) . "'>" . $contents . "</span>";
	}else{
		$wrapper = $contents;
	}
...
/* set_request_var - sets a given $_REQUEST variable 
